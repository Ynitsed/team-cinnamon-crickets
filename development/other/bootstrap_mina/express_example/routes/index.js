...
router.get('/form/:search_param', function(req, res) {
  ...
  res.render('search_results.ejs', { title: 'Express' , search_string: search_string});
});

/* GET home page. */
router.get('/form', function(req, res) {
	console.log(ingredients);
  res.render('form.ejs', { title: 'Express' , ingredients: ingredients});
});

/* GET home page. */
router.get('/search_results', function(req, res) {
  res.render('search_results.ejs', { title: 'Express' , data: data});
});
