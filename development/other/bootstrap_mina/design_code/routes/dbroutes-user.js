...
/*
	Route for /user/login:
		...
		Redirects to /search/main if user is already signed-in.
*/
...
/*
	Route for /user/auth:
		...
		Redirects to /search/main if user is already signed in or if the 
...
router.post('/auth', function(req, res) {
  ...
  if (user !== undefined) {
    ...
    db.login(req.body, function(error, user) {
      if (error) {
...
/*
	Route for /user/signup:
		...
		Redirects to /search/main if the user is already signed in.
*/
