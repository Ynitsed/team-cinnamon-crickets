...
insert into recipes values(DEFAULT, 'Average Asparagus', '{"asparagus"}', 'Take asparagus. Make asparagus', 15, 6, .1, .1, 0, 0, .3, .2, 4, 'rec_img_1');
insert into recipes values(DEFAULT, 'Basic Buttered Toast', '{"bread", "butter", "milk"}', 'Toast some bread, butter some Toast. Complex.', 5, 1, DEFAULT, DEFAULT, DEFAULT, DEFAULT, .2, DEFAULT, 5, 'rec_img_2');
insert into recipes values(DEFAULT, 'Corny Cutlet', '{"milk", "eggs", "butter"}', 'Take ingredients, make cutlet. Easy.', 200, 3, .8, 0, DEFAULT, DEFAULT, DEFAULT, 0, 5, 'rec_img_3');
insert into recipes values(DEFAULT, 'Default Doughnut', '{"flour", "butter", "milk"}', 'Make a doughnut', 60, 10, 1, 0, 1, 0, .2, 0, 5, 'rec_img_4');
insert into recipes values(DEFAULT, 'famous faghetti', '{"bread", "flour"}', 'take some bread and flour. make faghetti. It is famous', 25, 2, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 'rec_img_5');
